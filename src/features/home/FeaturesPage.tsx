  ...
  return (
    <div className="min-h-screen bg-dark-bg">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(230,57,70,0.15),transparent_60%)]" />
        <div className="container mx-auto px-4 py-16 sm:py-24 relative z-10 text-center">
          <img
            src={logoWhite}
            alt="FairPadel"
            className="w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-6 drop-shadow-2xl"
          />
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold mb-4 leading-tight">
            Todo lo que necesitas para
            <br />
            <span className="text-primary-500">tu torneo de padel</span>
          </h1>
          <p className="text-lg sm:text-xl text-light-secondary max-w-2xl mx-auto mb-8">
            La plataforma completa para organizar, gestionar y jugar torneos de padel en Paraguay.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/tournaments">
              <Button variant="primary" className="px-8 py-3 text-base">
                <Trophy className="w-5 h-5 mr-2" /> Explorar Torneos
              </Button>
            </Link>
            {!isAuthenticated ? (
              <Link to="/register">
              ...
              <Link to="/profile">
                <Button variant="outline" className="px-8 py-3 text-base border-light-muted">
                  Mi Perfil <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
              </Link>
            )}
          </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3">
            Funcionalidades <span className="text-primary-500">Principales</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((feat) => {
            ...
            return (
              <Card key={feat.title} className={`p-6 border ${feat.bg} hover:scale-[1.02] transition-transform duration-300`}>
      ...
      <section className="bg-dark-surface py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Visual lado derecho — composicion de iconos */}
                ...
                <div className="absolute inset-0 bg-dark-card border border-dark-border rounded-3xl shadow-2xl p-8 flex flex-col justify-between">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-dark-surface rounded-lg p-3 text-center">
                      ...
                      <p className="text-[10px] text-light-muted">Parejas</p>
                    </div>
                    <div className="bg-dark-surface rounded-lg p-3 text-center">
                      <DollarSign className="w-6 h-6 text-green-400 mx-auto mb-1" />
                      <p className="text-lg font-bold">Gs.12M</p>
                      <p className="text-[10px] text-light-muted">Recaudado</p>
                    </div>
                    <div className="bg-dark-surface rounded-lg p-3 text-center">
                      <BarChart2 className="w-6 h-6 text-purple-400 mx-auto mb-1" />
                      <p className="text-lg font-bold">96%</p>
                      <p className="text-[10px] text-light-muted">Ocupacion</p>
                    </div>
                  </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Visual lado izquierdo — perfil mockup */}
          <div className="hidden lg:flex items-center justify-center">
            <div className="relative w-80 h-80">
              ...
              <div className="absolute inset-0 bg-dark-card border border-dark-border rounded-3xl shadow-2xl p-8">
                ...
                <div className="flex gap-2 mb-4">
                  <div className="p-2 bg-amber-900/30 rounded-lg"><Trophy className="w-4 h-4 text-amber-400" /></div>
                  <div className="p-2 bg-purple-900/30 rounded-lg"><Star className="w-4 h-4 text-purple-400" /></div>
                  <div className="p-2 bg-green-900/30 rounded-lg"><Shield className="w-4 h-4 text-green-400" /></div>
                  <div className="p-2 bg-blue-900/30 rounded-lg"><Zap className="w-4 h-4 text-blue-400" /></div>
                </div>
                {/* Ranking bar */}
      ...
      <section className="bg-dark-surface py-16">
        <div className="container mx-auto px-4 text-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {CATEGORIES_CABALLEROS.map((cat, i) => (
                  <div
                    key={cat}
                    className="px-4 py-2 rounded-lg font-semibold text-sm border transition-colors hover:scale-105"
                    style={{
          ...
          <div className="mt-10 grid grid-cols-3 sm:grid-cols-6 gap-3 max-w-2xl mx-auto">
            {[
              { label: 'Campeon', pts: 100, color: 'amber' },
              { label: 'Finalista', pts: 60, color: 'gray' },
              { label: 'Semi', pts: 35, color: 'orange' },
              { label: 'Cuartos', pts: 15, color: 'blue' },
              { label: 'Octavos', pts: 8, color: 'purple' },
              { label: '1ra Ronda', pts: 3, color: 'green' },
            ].map((item) => (
              <div key={item.label} className="bg-dark-card border border-dark-border rounded-lg p-3 text-center">
      ...
      {/* ===== PREMIUM ===== */}
      <section className="container mx-auto px-4 py-16">
        <Card className="border-amber-500/30 bg-gradient-to-br from-amber-900/10 to-dark-card p-8 sm:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-3xl mx-auto mb-8">
              {PREMIUM_BENEFITS.map((benefit) => {
                ...
                return (
                  <div key={benefit.title} className="bg-dark-surface border border-amber-500/20 rounded-xl p-5 text-center hover:border-amber-500/40 transition-colors">
