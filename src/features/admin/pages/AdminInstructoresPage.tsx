  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-light-text">Solicitudes de Instructor</h1>
        <p className="text-sm sm:text-base text-light-secondary mt-1 sm:mt-2">Revisa y aprueba solicitudes de usuarios que desean ser instructores</p>
      </div>

      {/* Promover Instructor por Documento */}
      <Card className="mb-6">
        <CardHeader>
        ...
        <CardContent>
          <p className="text-sm text-light-secondary mb-4">
            Busca un usuario por su número de documento y asígnale el rol de instructor directamente, sin necesidad de solicitud.
          </p>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-light-secondary">
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            {solicitud.experienciaAnios} años de experiencia
                          </span>
                          {solicitud.ciudades && (
                            <span className="flex items-center gap-1">
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            {new Date(solicitud.createdAt).toLocaleDateString('es-PY')}
                          </span>
                        </div>
                              ...
                              <div className="flex gap-4">
                                {solicitud.precioIndividual != null && (
                                  <span className="flex items-center gap-1">
                                    ...
                                    Individual: Gs. {solicitud.precioIndividual.toLocaleString()}
                                  </span>
                                )}
                                {solicitud.precioGrupal != null && (
                                  <span className="flex items-center gap-1">
                                    <Target className="h-3 w-3" />
                                    Grupal: Gs. {solicitud.precioGrupal.toLocaleString()}
                                  </span>
                                )}
                              </div>
                            </div>
...
export default AdminInstructoresPage;
