    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-light-secondary mt-1">
          Tus reservas de clases con instructores
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          <Inbox className="h-16 w-16 mx-auto mb-4 text-light-muted opacity-50" />
          <h2 className="text-lg font-semibold text-light-text mb-1">No tenés reservas</h2>
          <p className="text-sm text-light-secondary mb-4">
            {filtro ? 'No hay reservas con ese filtro' : 'Buscá un instructor y reservá tu primera clase'}
          </p>
