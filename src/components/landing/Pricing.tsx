...
const plans = [
  ...
  },
  {
    ...
    icon: Star,
    price: '10.000',
    period: 'por jugador que jugó',
    description: 'Para quienes organizan torneos de pádel',
    features: [
      'Torneos ilimitados',
      'Sorteo justo con acomodación paraguaya',
      'Agenda por cancha y horario',
      'Tu propio ranking del circuito, gratis',
      'Cuadro público para compartir',
      'Cobrás como quieras: efectivo o transferencia',
    ],
